const levelData = [
  { name: "Easy", image: "../images/js-easy.png" },
  { name: "Medium", image: "../images/js-medium.png" },
  { name: "Hard", image: "../images/js-hard.png" },
];
...
levelData.forEach((level, index) => {
  ...
  if (isUnlocked) {
    ...
    card.onclick = () => {
      window.location.href = `js-quiz-level${levelNum}.html`;
    };
  }
